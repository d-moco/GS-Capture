 ...
 */
class QtCustomStylesheet : public QObject
{
	Q_OBJECT
private:
    QtCustomStylesheetPrivate* d; ///< private data (pimpl)
    friend struct QtCustomStylesheetPrivate;
...
public:
	 ...
	 * Default Constructor
	 */
    QtCustomStylesheet(QObject* parent = nullptr);

	/**
	 * Virtual Destructor
	 */
    virtual ~QtCustomStylesheet();
